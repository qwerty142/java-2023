...
public class Task13Test {
    ...
    @Test
    public void shouldReturnAnimalsWithNameOfMoreThanTwoWords() {
        // Given
        List<Animal> animals = List.of(fish, bird, cat, cat1, dog, spider);
        List<Animal> expected = List.of(bird, cat1);
        // When
        List<Animal> res = animalsWithNameOfMoreThanTwoWords(animals);
        // Then
